<?php
// scratch/create_rollout_downloads.php
$mdPath = 'C:\\Users\\wgdag\\.gemini\\antigravity\\brain\\f1f89816-943b-482c-88e9-745503a7c0ec\\implementation_rollout_plan.md';
...
file_put_contents($destDir . 'NIS_PPMS_Implementation_Plan_and_Deployment_Roadmap.md', $mdContent);
...
<head>
    ...
    <title>NIS-PPMS Enterprise Implementation Plan & Deployment Roadmap</title>
...
<div class="manual-container">
    <div class="toolbar">
        <div class="toolbar-title"><i class="fas fa-tasks"></i> NIS-PPMS Implementation Plan (90-Day Roadmap)</div>
        <div class="toolbar-btns">
            <button onclick="window.print();" class="btn-download"><i class="fas fa-print"></i> Print / Save as PDF</button>
            <a href="NIS_PPMS_Implementation_Plan_and_Deployment_Roadmap.md" download class="btn-download btn-secondary"><i class="fas fa-file-download"></i> Download Markdown (.md)</a>
        </div>
    </div>
    ...
    <div class="header-box">
        ...
        <p>Phase-by-Phase Implementation Plan & Deployment Roadmap</p>
    </div>
';

$parsedHtml = $mdContent;
$parsedHtml = preg_replace('/^# Nigeria Immigration Service.*?\n---/s', '', $parsedHtml);
$parsedHtml = preg_replace('/> \[!IMPORTANT\]\s*\n>\s*(.*?)(?=\n\n|\n[^\>]|$)/s', '<div class="alert-box danger"><strong>RESTRICTED NOTICE:</strong> $1</div>', $parsedHtml);
...
file_put_contents($destDir . 'NIS_PPMS_Implementation_Plan_and_Deployment_Roadmap.html', $htmlHeader . $parsedHtml . $htmlFooter);

echo "Rollout plan downloads created successfully!\n";
